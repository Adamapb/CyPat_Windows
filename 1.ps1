...
reg-key-edit "HKEY_LOCAL_MACHINE\Software\Microsoft\Windows\CurrentVersion\Explorer\Advanced" "TaskBarSizeMove" "REG_DWORD" "0"
reg-key-edit "HKEY_LOCAL_MACHINE\Software\Policies\Microsoft\Windows\Peernet" "Disabled" "REG_DWORD" "0"
reg-key-edit "HKEY_LOCAL_MACHINE\Software\Policies\Microsoft\Windows\CloudContent" "DisableCloudOptimizedContent" "REG_DWORD" "1"
reg-key-edit "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\CredUI" "DisablePasswordReveal" "REG_DWORD" "1"
...
#Make sure subsystem sint installed